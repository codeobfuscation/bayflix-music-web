...
curl -sI --max-time 10 "https://bayflix.ms/assets/$asset_file" 2>&1 | head -3
echo
echo "=== web-app-manifest-512 ==="
curl -sI --max-time 10 https://bayflix.ms/web-app-manifest-512x512.png 2>&1 | head -3
echo
echo "=== sw.js ==="
curl -sI --max-time 10 https://bayflix.ms/sw.js 2>&1 | head -3
echo
echo "=== bayflix.png ==="
curl -sI --max-time 10 https://bayflix.ms/assets/bayflix.png 2>&1 | head -3
